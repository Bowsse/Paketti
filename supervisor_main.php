...
function printTheses($theses)
{
    ...
    foreach ($theses as $thesis)
    {
        ...
        // Sickening, I know
        echo "<tr><td><a href='supervisor_thesis.php?thesisID=$thesisID'>" . $thesis["subject"] . "</a></td><td>" . $info["personID"] . " </td><td>" . $info["firstname"] . " " . $info["lastname"] . " </td><td>" . $thesis["estimatedDate"] . "</td><td><a href=" . $version["thesisUrl"]. " target='_blank'>" . $version["version"]. "</a></td></tr>";
    }
    echo "</table>";
